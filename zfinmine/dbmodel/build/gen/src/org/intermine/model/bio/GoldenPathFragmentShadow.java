...
public class GoldenPathFragmentShadow implements GoldenPathFragment, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = GoldenPathFragment.class;
    // Col: org.intermine.model.bio.GoldenPathFragment.goldenPaths
    protected java.util.Set<org.intermine.model.bio.GoldenPath> goldenPaths = new java.util.HashSet();
    public java.util.Set<org.intermine.model.bio.GoldenPath> getGoldenPaths() { return goldenPaths; }
    public void setGoldenPaths(final java.util.Set<org.intermine.model.bio.GoldenPath> goldenPaths) { this.goldenPaths = goldenPaths; }
    public void addGoldenPaths(final org.intermine.model.bio.GoldenPath arg) { goldenPaths.add(arg); }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("goldenPaths".equals(fieldName)) {
            goldenPaths = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        goldenPaths = new ProxyCollection(os, this, "goldenPaths", org.intermine.model.bio.GoldenPath.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("goldenPaths".equals(fieldName)) {
            goldenPaths.add((org.intermine.model.bio.GoldenPath) element);
        } else if ("constructs".equals(fieldName)) {
    ...
    public Class getElementType(final String fieldName) {
        if ("goldenPaths".equals(fieldName)) {
            return org.intermine.model.bio.GoldenPath.class;
        }
        if ("constructs".equals(fieldName)) {
