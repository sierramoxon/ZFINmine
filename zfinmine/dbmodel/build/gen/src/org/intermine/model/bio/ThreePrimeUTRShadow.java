...
public class ThreePrimeUTRShadow implements ThreePrimeUTR, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = ThreePrimeUTR.class;
    // Col: org.intermine.model.bio.ThreePrimeUTR.polyASequences
    protected java.util.Set<org.intermine.model.bio.PolyASequence> polyASequences = new java.util.HashSet();
    public java.util.Set<org.intermine.model.bio.PolyASequence> getPolyASequences() { return polyASequences; }
    public void setPolyASequences(final java.util.Set<org.intermine.model.bio.PolyASequence> polyASequences) { this.polyASequences = polyASequences; }
    public void addPolyASequences(final org.intermine.model.bio.PolyASequence arg) { polyASequences.add(arg); }

    // Ref: org.intermine.model.bio.UTR.MRNA
    ...
    // Col: org.intermine.model.bio.UTR.ribosomeEntrySites
    protected java.util.Set<org.intermine.model.bio.RibosomeEntrySite> ribosomeEntrySites = new java.util.HashSet();
    public java.util.Set<org.intermine.model.bio.RibosomeEntrySite> getRibosomeEntrySites() { return ribosomeEntrySites; }
    public void setRibosomeEntrySites(final java.util.Set<org.intermine.model.bio.RibosomeEntrySite> ribosomeEntrySites) { this.ribosomeEntrySites = ribosomeEntrySites; }
    public void addRibosomeEntrySites(final org.intermine.model.bio.RibosomeEntrySite arg) { ribosomeEntrySites.add(arg); }
    ...
    public boolean equals(Object o) { return (o instanceof ThreePrimeUTR && id != null) ? id.equals(((ThreePrimeUTR)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "ThreePrimeUTR [MRNA=" + (MRNA == null ? "null" : (MRNA.getId() == null ? "no id" : MRNA.getId().toString())) + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", comments=\"" + comments + "\", curated=\"" + curated + "\", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", id=\"" + id + "\", length=\"" + length + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", symbol=\"" + symbol + "\", type=\"" + type + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("polyASequences".equals(fieldName)) {
            return polyASequences;
        }
        ...
        if ("ribosomeEntrySites".equals(fieldName)) {
            return ribosomeEntrySites;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("polyASequences".equals(fieldName)) {
            polyASequences = (java.util.Set) value;
        ...
        } else if ("ribosomeEntrySites".equals(fieldName)) {
            ribosomeEntrySites = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        polyASequences = new ProxyCollection(os, this, "polyASequences", org.intermine.model.bio.PolyASequence.class);
        ribosomeEntrySites = new ProxyCollection(os, this, "ribosomeEntrySites", org.intermine.model.bio.RibosomeEntrySite.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("polyASequences".equals(fieldName)) {
            polyASequences.add((org.intermine.model.bio.PolyASequence) element);
        } else if ("ribosomeEntrySites".equals(fieldName)) {
            ribosomeEntrySites.add((org.intermine.model.bio.RibosomeEntrySite) element);
        } else if ("constructs".equals(fieldName)) {
    ...
    public Class getElementType(final String fieldName) {
        if ("polyASequences".equals(fieldName)) {
            return org.intermine.model.bio.PolyASequence.class;
        }
        if ("ribosomeEntrySites".equals(fieldName)) {
            return org.intermine.model.bio.RibosomeEntrySite.class;
        }
        if ("constructs".equals(fieldName)) {
