...
public class AuthorShadow implements Author, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = Author.class;
    ...
    public boolean equals(Object o) { return (o instanceof Author && id != null) ? id.equals(((Author)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "Author [id=\"" + id + "\", name=\"" + name + "\"]"; }
