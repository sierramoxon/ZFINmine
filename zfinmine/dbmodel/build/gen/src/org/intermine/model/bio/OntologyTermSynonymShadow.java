...
public class OntologyTermSynonymShadow implements OntologyTermSynonym, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = OntologyTermSynonym.class;
    ...
    public boolean equals(Object o) { return (o instanceof OntologyTermSynonym && id != null) ? id.equals(((OntologyTermSynonym)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "OntologyTermSynonym [id=\"" + id + "\", name=\"" + name + "\", type=\"" + type + "\"]"; }
