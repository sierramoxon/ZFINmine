...
public class ChromosomeShadow implements Chromosome, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = Chromosome.class;
    // Col: org.intermine.model.bio.Chromosome.features
    protected java.util.Set<org.intermine.model.bio.LocatedSequenceFeature> features = new java.util.HashSet();
    public java.util.Set<org.intermine.model.bio.LocatedSequenceFeature> getFeatures() { return features; }
    public void setFeatures(final java.util.Set<org.intermine.model.bio.LocatedSequenceFeature> features) { this.features = features; }
    public void addFeatures(final org.intermine.model.bio.LocatedSequenceFeature arg) { features.add(arg); }

    // Col: org.intermine.model.bio.Chromosome.exons
    ...
    // Col: org.intermine.model.bio.Chromosome.crossGenomeMatches
    protected java.util.Set<org.intermine.model.bio.CrossGenomeMatch> crossGenomeMatches = new java.util.HashSet();
    public java.util.Set<org.intermine.model.bio.CrossGenomeMatch> getCrossGenomeMatches() { return crossGenomeMatches; }
    public void setCrossGenomeMatches(final java.util.Set<org.intermine.model.bio.CrossGenomeMatch> crossGenomeMatches) { this.crossGenomeMatches = crossGenomeMatches; }
    public void addCrossGenomeMatches(final org.intermine.model.bio.CrossGenomeMatch arg) { crossGenomeMatches.add(arg); }

    // Col: org.intermine.model.bio.Chromosome.chromosomeBands
    protected java.util.Set<org.intermine.model.bio.ChromosomeBand> chromosomeBands = new java.util.HashSet();
    public java.util.Set<org.intermine.model.bio.ChromosomeBand> getChromosomeBands() { return chromosomeBands; }
    public void setChromosomeBands(final java.util.Set<org.intermine.model.bio.ChromosomeBand> chromosomeBands) { this.chromosomeBands = chromosomeBands; }
    public void addChromosomeBands(final org.intermine.model.bio.ChromosomeBand arg) { chromosomeBands.add(arg); }

    // Col: org.intermine.model.bio.Chromosome.chromosomalStructuralElements
    protected java.util.Set<org.intermine.model.bio.ChromosomalStructuralElement> chromosomalStructuralElements = new java.util.HashSet();
    public java.util.Set<org.intermine.model.bio.ChromosomalStructuralElement> getChromosomalStructuralElements() { return chromosomalStructuralElements; }
    public void setChromosomalStructuralElements(final java.util.Set<org.intermine.model.bio.ChromosomalStructuralElement> chromosomalStructuralElements) { this.chromosomalStructuralElements = chromosomalStructuralElements; }
    public void addChromosomalStructuralElements(final org.intermine.model.bio.ChromosomalStructuralElement arg) { chromosomalStructuralElements.add(arg); }

    // Col: org.intermine.model.bio.Chromosome.transcripts
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("crossGenomeMatches".equals(fieldName)) {
            return crossGenomeMatches;
        }
        if ("chromosomeBands".equals(fieldName)) {
            return chromosomeBands;
        }
        if ("chromosomalStructuralElements".equals(fieldName)) {
            return chromosomalStructuralElements;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("crossGenomeMatches".equals(fieldName)) {
            crossGenomeMatches = (java.util.Set) value;
        } else if ("chromosomeBands".equals(fieldName)) {
            chromosomeBands = (java.util.Set) value;
        } else if ("chromosomalStructuralElements".equals(fieldName)) {
            chromosomalStructuralElements = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        features = new ProxyCollection(os, this, "features", org.intermine.model.bio.LocatedSequenceFeature.class);
        ...
        crossGenomeMatches = new ProxyCollection(os, this, "crossGenomeMatches", org.intermine.model.bio.CrossGenomeMatch.class);
        chromosomeBands = new ProxyCollection(os, this, "chromosomeBands", org.intermine.model.bio.ChromosomeBand.class);
        chromosomalStructuralElements = new ProxyCollection(os, this, "chromosomalStructuralElements", org.intermine.model.bio.ChromosomalStructuralElement.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("features".equals(fieldName)) {
            features.add((org.intermine.model.bio.LocatedSequenceFeature) element);
        } else if ("exons".equals(fieldName)) {
            exons.add((org.intermine.model.bio.Exon) element);
        } else if ("genes".equals(fieldName)) {
            genes.add((org.intermine.model.bio.Gene) element);
        } else if ("crossGenomeMatches".equals(fieldName)) {
            crossGenomeMatches.add((org.intermine.model.bio.CrossGenomeMatch) element);
        } else if ("chromosomeBands".equals(fieldName)) {
            chromosomeBands.add((org.intermine.model.bio.ChromosomeBand) element);
        } else if ("chromosomalStructuralElements".equals(fieldName)) {
            chromosomalStructuralElements.add((org.intermine.model.bio.ChromosomalStructuralElement) element);
        } else if ("transcripts".equals(fieldName)) {
    ...
    public Class getElementType(final String fieldName) {
        ...
        if ("crossGenomeMatches".equals(fieldName)) {
            return org.intermine.model.bio.CrossGenomeMatch.class;
        }
        if ("chromosomeBands".equals(fieldName)) {
            return org.intermine.model.bio.ChromosomeBand.class;
        }
        if ("chromosomalStructuralElements".equals(fieldName)) {
            return org.intermine.model.bio.ChromosomalStructuralElement.class;
        }
        if ("transcripts".equals(fieldName)) {
