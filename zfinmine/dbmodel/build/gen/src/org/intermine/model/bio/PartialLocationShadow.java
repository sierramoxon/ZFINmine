...
public class PartialLocationShadow implements PartialLocation, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = PartialLocation.class;
    // Attr: org.intermine.model.bio.PartialLocation.subjectStart
    protected java.lang.Integer subjectStart;
    public java.lang.Integer getSubjectStart() { return subjectStart; }
    public void setSubjectStart(final java.lang.Integer subjectStart) { this.subjectStart = subjectStart; }

    // Attr: org.intermine.model.bio.PartialLocation.subjectEnd
    protected java.lang.Integer subjectEnd;
    public java.lang.Integer getSubjectEnd() { return subjectEnd; }
    public void setSubjectEnd(final java.lang.Integer subjectEnd) { this.subjectEnd = subjectEnd; }
    ...
    public boolean equals(Object o) { return (o instanceof PartialLocation && id != null) ? id.equals(((PartialLocation)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "PartialLocation [end=\"" + end + "\", endIsPartial=\"" + endIsPartial + "\", endPhase=\"" + endPhase + "\", id=\"" + id + "\", object=" + (object == null ? "null" : (object.getId() == null ? "no id" : object.getId().toString())) + ", phase=\"" + phase + "\", start=\"" + start + "\", startIsPartial=\"" + startIsPartial + "\", strand=\"" + strand + "\", subject=" + (subject == null ? "null" : (subject.getId() == null ? "no id" : subject.getId().toString())) + ", subjectEnd=\"" + subjectEnd + "\", subjectStart=\"" + subjectStart + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("subjectStart".equals(fieldName)) {
            return subjectStart;
        }
        if ("subjectEnd".equals(fieldName)) {
            return subjectEnd;
        }
        ...
        if (!org.intermine.model.bio.PartialLocation.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("subjectStart".equals(fieldName)) {
            subjectStart = (java.lang.Integer) value;
        } else if ("subjectEnd".equals(fieldName)) {
            subjectEnd = (java.lang.Integer) value;
    ...
    public Class getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.PartialLocation.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.PartialLocation.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        ...
        sb.append("$_^org.intermine.model.bio.PartialLocation");
        if (subjectStart != null) {
            sb.append("$_^asubjectStart$_^").append(subjectStart);
        }
        if (subjectEnd != null) {
            sb.append("$_^asubjectEnd$_^").append(subjectEnd);
        }
        if (end != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.PartialLocation.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.PartialLocation)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "asubjectStart".equals(notXml[i])) {
                i++;
                subjectStart = Integer.valueOf(notXml[i]);
                i++;
            }
            if ((i < notXml.length) && "asubjectEnd".equals(notXml[i])) {
                i++;
                subjectEnd = Integer.valueOf(notXml[i]);
                i++;
            }
    ...
    public Class getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.PartialLocation.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.PartialLocation.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
