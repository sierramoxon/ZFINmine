...
public class MatchPartShadow implements MatchPart, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = MatchPart.class;
    // Col: org.intermine.model.bio.MatchPart.matchSets
    protected java.util.Set<org.intermine.model.bio.MatchSet> matchSets = new java.util.HashSet();
    public java.util.Set<org.intermine.model.bio.MatchSet> getMatchSets() { return matchSets; }
    public void setMatchSets(final java.util.Set<org.intermine.model.bio.MatchSet> matchSets) { this.matchSets = matchSets; }
    public void addMatchSets(final org.intermine.model.bio.MatchSet arg) { matchSets.add(arg); }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        matchSets = new ProxyCollection(os, this, "matchSets", org.intermine.model.bio.MatchSet.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("matchSets".equals(fieldName)) {
            matchSets.add((org.intermine.model.bio.MatchSet) element);
        } else if ("constructs".equals(fieldName)) {
    ...
    public Class getElementType(final String fieldName) {
        if ("matchSets".equals(fieldName)) {
            return org.intermine.model.bio.MatchSet.class;
        }
        if ("constructs".equals(fieldName)) {
