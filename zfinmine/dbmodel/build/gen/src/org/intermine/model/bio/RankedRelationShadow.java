...
public class RankedRelationShadow implements RankedRelation, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = RankedRelation.class;
    // Attr: org.intermine.model.bio.RankedRelation.rank
    protected java.lang.Integer rank;
    public java.lang.Integer getRank() { return rank; }
    public void setRank(final java.lang.Integer rank) { this.rank = rank; }
    ...
    public boolean equals(Object o) { return (o instanceof RankedRelation && id != null) ? id.equals(((RankedRelation)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "RankedRelation [id=\"" + id + "\", object=" + (object == null ? "null" : (object.getId() == null ? "no id" : object.getId().toString())) + ", rank=\"" + rank + "\", subject=" + (subject == null ? "null" : (subject.getId() == null ? "no id" : subject.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.RankedRelation.class.equals(getClass())) {
    ...
    public Class getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.RankedRelation.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.RankedRelation.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        ...
        sb.append("$_^org.intermine.model.bio.RankedRelation");
        if (rank != null) {
            sb.append("$_^arank$_^").append(rank);
        }
        if (subject != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.RankedRelation.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.RankedRelation)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "arank".equals(notXml[i])) {
                i++;
                rank = Integer.valueOf(notXml[i]);
                i++;
            }
    ...
    public Class getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.RankedRelation.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.RankedRelation.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
