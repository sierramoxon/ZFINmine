...
public class ComputationalResultShadow implements ComputationalResult, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = ComputationalResult.class;
    // Attr: org.intermine.model.bio.ComputationalResult.score
    ...
    // Attr: org.intermine.model.bio.ComputationalResult.type
    ...
    public boolean equals(Object o) { return (o instanceof ComputationalResult && id != null) ? id.equals(((ComputationalResult)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "ComputationalResult [analysis=" + (analysis == null ? "null" : (analysis.getId() == null ? "no id" : analysis.getId().toString())) + ", confidence=\"" + confidence + "\", id=\"" + id + "\", score=\"" + score + "\", type=\"" + type + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.ComputationalResult.class.equals(getClass())) {
    ...
    public Class getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ComputationalResult.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.ComputationalResult.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        ...
        sb.append("$_^org.intermine.model.bio.ComputationalResult");
        if (score != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ComputationalResult.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.ComputationalResult)");
        }
    ...
    public Class getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ComputationalResult.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.ComputationalResult.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
