...
public class BioEntityShadow implements BioEntity, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = BioEntity.class;
    ...
    public boolean equals(Object o) { return (o instanceof BioEntity && id != null) ? id.equals(((BioEntity)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "BioEntity [curated=\"" + curated + "\", id=\"" + id + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\"]"; }
