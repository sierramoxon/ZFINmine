...
public class SyntenicRegionShadow implements SyntenicRegion, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = SyntenicRegion.class;
    // Ref: org.intermine.model.bio.SyntenicRegion.targetSyntenicRegion
    protected org.intermine.model.InterMineObject targetSyntenicRegion;
    public org.intermine.model.bio.SyntenicRegion getTargetSyntenicRegion() { if (targetSyntenicRegion instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.SyntenicRegion) ((org.intermine.objectstore.proxy.ProxyReference) targetSyntenicRegion).getObject()); }; return (org.intermine.model.bio.SyntenicRegion) targetSyntenicRegion; }
    public void setTargetSyntenicRegion(final org.intermine.model.bio.SyntenicRegion targetSyntenicRegion) { this.targetSyntenicRegion = targetSyntenicRegion; }
    public void proxyTargetSyntenicRegion(final org.intermine.objectstore.proxy.ProxyReference targetSyntenicRegion) { this.targetSyntenicRegion = targetSyntenicRegion; }
    public org.intermine.model.InterMineObject proxGetTargetSyntenicRegion() { return targetSyntenicRegion; }

    // Ref: org.intermine.model.bio.SyntenicRegion.targetOrganism
    ...
    public boolean equals(Object o) { return (o instanceof SyntenicRegion && id != null) ? id.equals(((SyntenicRegion)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "SyntenicRegion [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", comments=\"" + comments + "\", curated=\"" + curated + "\", id=\"" + id + "\", length=\"" + length + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", symbol=\"" + symbol + "\", targetOrganism=" + (targetOrganism == null ? "null" : (targetOrganism.getId() == null ? "no id" : targetOrganism.getId().toString())) + ", targetSyntenicRegion=" + (targetSyntenicRegion == null ? "null" : (targetSyntenicRegion.getId() == null ? "no id" : targetSyntenicRegion.getId().toString())) + ", type=\"" + type + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("targetSyntenicRegion".equals(fieldName)) {
            if (targetSyntenicRegion instanceof ProxyReference) {
                return ((ProxyReference) targetSyntenicRegion).getObject();
            } else {
                return targetSyntenicRegion;
            }
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("targetSyntenicRegion".equals(fieldName)) {
            targetSyntenicRegion = (org.intermine.model.InterMineObject) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (targetSyntenicRegion != null) {
            sb.append("$_^rtargetSyntenicRegion$_^").append(targetSyntenicRegion.getId());
        }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rtargetSyntenicRegion".equals(notXml[i])) {
                i++;
                targetSyntenicRegion = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.SyntenicRegion.class);
                i++;
            };
