...
public class SequenceOntologyTermShadow implements SequenceOntologyTerm, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = SequenceOntologyTerm.class;
    ...
    public boolean equals(Object o) { return (o instanceof SequenceOntologyTerm && id != null) ? id.equals(((SequenceOntologyTerm)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "SequenceOntologyTerm [description=\"" + description + "\", id=\"" + id + "\", identifier=\"" + identifier + "\", name=\"" + name + "\", namespace=\"" + namespace + "\", obsolete=\"" + obsolete + "\", ontology=" + (ontology == null ? "null" : (ontology.getId() == null ? "no id" : ontology.getId().toString())) + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", stageAbbreviation=\"" + stageAbbreviation + "\", stageEndHour=\"" + stageEndHour + "\", stageStartHour=\"" + stageStartHour + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.SequenceOntologyTerm.class.equals(getClass())) {
    ...
    public Class getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.SequenceOntologyTerm.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.SequenceOntologyTerm.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        ...
        sb.append("$_^org.intermine.model.bio.SequenceOntologyTerm");
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.SequenceOntologyTerm.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.SequenceOntologyTerm)");
        }
    ...
    public Class getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.SequenceOntologyTerm.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.SequenceOntologyTerm.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
