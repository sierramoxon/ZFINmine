...
public class CDSShadow implements CDS, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = CDS.class;
    // Ref: org.intermine.model.bio.CDS.MRNA
    ...
    // Col: org.intermine.model.bio.CDS.polypeptides
    protected java.util.Set<org.intermine.model.bio.Polypeptide> polypeptides = new java.util.HashSet();
    ...
    public boolean equals(Object o) { return (o instanceof CDS && id != null) ? id.equals(((CDS)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "CDS [MRNA=" + (MRNA == null ? "null" : (MRNA.getId() == null ? "no id" : MRNA.getId().toString())) + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", comments=\"" + comments + "\", curated=\"" + curated + "\", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", id=\"" + id + "\", length=\"" + length + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", protein=" + (protein == null ? "null" : (protein.getId() == null ? "no id" : protein.getId().toString())) + ", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", symbol=\"" + symbol + "\", type=\"" + type + "\"]"; }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        polypeptides = new ProxyCollection(os, this, "polypeptides", org.intermine.model.bio.Polypeptide.class);
