...
public class AnalysisShadow implements Analysis, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = Analysis.class;
    ...
    public boolean equals(Object o) { return (o instanceof Analysis && id != null) ? id.equals(((Analysis)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "Analysis [id=\"" + id + "\", publication=" + (publication == null ? "null" : (publication.getId() == null ? "no id" : publication.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.Analysis.class.equals(getClass())) {
    ...
    public Class getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Analysis.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.Analysis.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        ...
        sb.append("$_^org.intermine.model.bio.Analysis");
        if (publication != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.Analysis.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.Analysis)");
        }
    ...
    public Class getElementType(final String fieldName) {
        if (!org.intermine.model.bio.Analysis.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.Analysis.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
