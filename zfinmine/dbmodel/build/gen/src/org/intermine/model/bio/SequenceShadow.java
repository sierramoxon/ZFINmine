...
public class SequenceShadow implements Sequence, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = Sequence.class;
    ...
    public java.lang.String getResidues() { return residues; }
    public void setResidues(final java.lang.String residues) { this.residues = residues; }
    ...
    public boolean equals(Object o) { return (o instanceof Sequence && id != null) ? id.equals(((Sequence)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "Sequence [id=\"" + id + "\", length=\"" + length + "\", md5checksum=\"" + md5checksum + "\", residues=\"" + residues + "\"]"; }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("length".equals(fieldName)) {
            ...
            residues = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (residues != null) {
            sb.append("$_^aresidues$_^");
            String string = residues;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "aresidues".equals(notXml[i])) {
                ...
                residues = string == null ? notXml[i] : string.toString();
                i++;
            }
