...
public class TransposableElementGeneShadow implements TransposableElementGene, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = TransposableElementGene.class;
    // Attr: org.intermine.model.bio.Gene.VegaId
    ...
    protected java.util.Set<org.intermine.model.bio.Genotype> genotypes = new java.util.HashSet();
    ...
    protected java.util.Set<org.intermine.model.bio.RegulatoryRegion> regulatoryRegions = new java.util.HashSet();
    ...
    protected java.util.Set<org.intermine.model.bio.GeneFlankingRegion> flankingRegions = new java.util.HashSet();
    ...
    protected java.util.Set<org.intermine.model.bio.Pathway> pathways = new java.util.HashSet();
    ...
    protected java.util.Set<org.intermine.model.bio.Protein> proteins = new java.util.HashSet();
    ...
    protected java.util.Set<org.intermine.model.bio.Construct> promotes = new java.util.HashSet();
    ...
    protected java.util.Set<org.intermine.model.bio.Clone> cloneArtifacts = new java.util.HashSet();
    ...
    protected java.util.Set<org.intermine.model.bio.Construct> codingSequenceOf = new java.util.HashSet();
    ...
    protected java.util.Set<org.intermine.model.bio.Clone> encodes = new java.util.HashSet();
    ...
    protected java.util.Set<org.intermine.model.bio.GOAnnotation> goAnnotation = new java.util.HashSet();
    ...
    protected java.util.Set<org.intermine.model.bio.Homologue> homologues = new java.util.HashSet();
    ...
    public boolean equals(Object o) { return (o instanceof TransposableElementGene && id != null) ? id.equals(((TransposableElementGene)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "TransposableElementGene [VegaId=\"" + VegaId + "\", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", comments=\"" + comments + "\", curated=\"" + curated + "\", downstreamIntergenicRegion=" + (downstreamIntergenicRegion == null ? "null" : (downstreamIntergenicRegion.getId() == null ? "no id" : downstreamIntergenicRegion.getId().toString())) + ", id=\"" + id + "\", length=\"" + length + "\", name=\"" + name + "\", ncbiGeneNumber=\"" + ncbiGeneNumber + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", symbol=\"" + symbol + "\", type=\"" + type + "\", upstreamIntergenicRegion=" + (upstreamIntergenicRegion == null ? "null" : (upstreamIntergenicRegion.getId() == null ? "no id" : upstreamIntergenicRegion.getId().toString())) + "]"; }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        genotypes = new ProxyCollection(os, this, "genotypes", org.intermine.model.bio.Genotype.class);
        expressions = new ProxyCollection(os, this, "expressions", org.intermine.model.bio.ExpressionResult.class);
        regulatoryRegions = new ProxyCollection(os, this, "regulatoryRegions", org.intermine.model.bio.RegulatoryRegion.class);
        ...
        flankingRegions = new ProxyCollection(os, this, "flankingRegions", org.intermine.model.bio.GeneFlankingRegion.class);
        pathways = new ProxyCollection(os, this, "pathways", org.intermine.model.bio.Pathway.class);
        ...
        promotes = new ProxyCollection(os, this, "promotes", org.intermine.model.bio.Construct.class);
        ...
        cloneArtifacts = new ProxyCollection(os, this, "cloneArtifacts", org.intermine.model.bio.Clone.class);
        codingSequenceOf = new ProxyCollection(os, this, "codingSequenceOf", org.intermine.model.bio.Construct.class);
        encodes = new ProxyCollection(os, this, "encodes", org.intermine.model.bio.Clone.class);
        goAnnotation = new ProxyCollection(os, this, "goAnnotation", org.intermine.model.bio.GOAnnotation.class);
        snps = new ProxyCollection(os, this, "snps", org.intermine.model.bio.SNP.class);
        homologues = new ProxyCollection(os, this, "homologues", org.intermine.model.bio.Homologue.class);
