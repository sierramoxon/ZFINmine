...
public class TerminatorShadow implements Terminator, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = Terminator.class;
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.Terminator.class.equals(getClass())) {
    ...
    public Class getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Terminator.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.Terminator.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        ...
        sb.append("$_^org.intermine.model.bio.Terminator");
        if (gene != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.Terminator.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.Terminator)");
        }
    ...
    public Class getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Terminator.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.Terminator.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
