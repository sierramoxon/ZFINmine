...
public class CrossGenomeMatchShadow implements CrossGenomeMatch, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = CrossGenomeMatch.class;
    // Attr: org.intermine.model.bio.CrossGenomeMatch.identifier
    ...
    // Ref: org.intermine.model.bio.CrossGenomeMatch.targetLocatedSequenceFeatureLocation
    protected org.intermine.model.InterMineObject targetLocatedSequenceFeatureLocation;
    public org.intermine.model.bio.Location getTargetLocatedSequenceFeatureLocation() { if (targetLocatedSequenceFeatureLocation instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Location) ((org.intermine.objectstore.proxy.ProxyReference) targetLocatedSequenceFeatureLocation).getObject()); }; return (org.intermine.model.bio.Location) targetLocatedSequenceFeatureLocation; }
    public void setTargetLocatedSequenceFeatureLocation(final org.intermine.model.bio.Location targetLocatedSequenceFeatureLocation) { this.targetLocatedSequenceFeatureLocation = targetLocatedSequenceFeatureLocation; }
    public void proxyTargetLocatedSequenceFeatureLocation(final org.intermine.objectstore.proxy.ProxyReference targetLocatedSequenceFeatureLocation) { this.targetLocatedSequenceFeatureLocation = targetLocatedSequenceFeatureLocation; }
    public org.intermine.model.InterMineObject proxGetTargetLocatedSequenceFeatureLocation() { return targetLocatedSequenceFeatureLocation; }

    // Ref: org.intermine.model.bio.CrossGenomeMatch.targetLocatedSequenceFeature
    protected org.intermine.model.InterMineObject targetLocatedSequenceFeature;
    public org.intermine.model.bio.LocatedSequenceFeature getTargetLocatedSequenceFeature() { if (targetLocatedSequenceFeature instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.LocatedSequenceFeature) ((org.intermine.objectstore.proxy.ProxyReference) targetLocatedSequenceFeature).getObject()); }; return (org.intermine.model.bio.LocatedSequenceFeature) targetLocatedSequenceFeature; }
    public void setTargetLocatedSequenceFeature(final org.intermine.model.bio.LocatedSequenceFeature targetLocatedSequenceFeature) { this.targetLocatedSequenceFeature = targetLocatedSequenceFeature; }
    public void proxyTargetLocatedSequenceFeature(final org.intermine.objectstore.proxy.ProxyReference targetLocatedSequenceFeature) { this.targetLocatedSequenceFeature = targetLocatedSequenceFeature; }
    public org.intermine.model.InterMineObject proxGetTargetLocatedSequenceFeature() { return targetLocatedSequenceFeature; }

    // Ref: org.intermine.model.bio.CrossGenomeMatch.targetOrganism
    protected org.intermine.model.InterMineObject targetOrganism;
    public org.intermine.model.bio.Organism getTargetOrganism() { if (targetOrganism instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Organism) ((org.intermine.objectstore.proxy.ProxyReference) targetOrganism).getObject()); }; return (org.intermine.model.bio.Organism) targetOrganism; }
    public void setTargetOrganism(final org.intermine.model.bio.Organism targetOrganism) { this.targetOrganism = targetOrganism; }
    public void proxyTargetOrganism(final org.intermine.objectstore.proxy.ProxyReference targetOrganism) { this.targetOrganism = targetOrganism; }
    public org.intermine.model.InterMineObject proxGetTargetOrganism() { return targetOrganism; }
    ...
    public boolean equals(Object o) { return (o instanceof CrossGenomeMatch && id != null) ? id.equals(((CrossGenomeMatch)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "CrossGenomeMatch [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", comments=\"" + comments + "\", curated=\"" + curated + "\", id=\"" + id + "\", identifier=\"" + identifier + "\", length=\"" + length + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", symbol=\"" + symbol + "\", targetLocatedSequenceFeature=" + (targetLocatedSequenceFeature == null ? "null" : (targetLocatedSequenceFeature.getId() == null ? "no id" : targetLocatedSequenceFeature.getId().toString())) + ", targetLocatedSequenceFeatureLocation=" + (targetLocatedSequenceFeatureLocation == null ? "null" : (targetLocatedSequenceFeatureLocation.getId() == null ? "no id" : targetLocatedSequenceFeatureLocation.getId().toString())) + ", targetOrganism=" + (targetOrganism == null ? "null" : (targetOrganism.getId() == null ? "no id" : targetOrganism.getId().toString())) + ", type=\"" + type + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("identifier".equals(fieldName)) {
            return identifier;
        }
        if ("targetLocatedSequenceFeatureLocation".equals(fieldName)) {
            if (targetLocatedSequenceFeatureLocation instanceof ProxyReference) {
                return ((ProxyReference) targetLocatedSequenceFeatureLocation).getObject();
            } else {
                return targetLocatedSequenceFeatureLocation;
            }
        }
        if ("targetLocatedSequenceFeature".equals(fieldName)) {
            if (targetLocatedSequenceFeature instanceof ProxyReference) {
                return ((ProxyReference) targetLocatedSequenceFeature).getObject();
            } else {
                return targetLocatedSequenceFeature;
            }
        }
        if ("targetOrganism".equals(fieldName)) {
            if (targetOrganism instanceof ProxyReference) {
                return ((ProxyReference) targetOrganism).getObject();
            } else {
        ...
        if (!org.intermine.model.bio.CrossGenomeMatch.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("targetLocatedSequenceFeatureLocation".equals(fieldName)) {
            targetLocatedSequenceFeatureLocation = (org.intermine.model.InterMineObject) value;
        } else if ("targetLocatedSequenceFeature".equals(fieldName)) {
            targetLocatedSequenceFeature = (org.intermine.model.InterMineObject) value;
        } else if ("targetOrganism".equals(fieldName)) {
            targetOrganism = (org.intermine.model.InterMineObject) value;
    ...
    public Class getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.CrossGenomeMatch.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.CrossGenomeMatch.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        ...
        sb.append("$_^org.intermine.model.bio.CrossGenomeMatch");
        if (identifier != null) {
        ...
        if (targetLocatedSequenceFeatureLocation != null) {
            sb.append("$_^rtargetLocatedSequenceFeatureLocation$_^").append(targetLocatedSequenceFeatureLocation.getId());
        }
        if (targetLocatedSequenceFeature != null) {
            sb.append("$_^rtargetLocatedSequenceFeature$_^").append(targetLocatedSequenceFeature.getId());
        }
        if (targetOrganism != null) {
            sb.append("$_^rtargetOrganism$_^").append(targetOrganism.getId());
        }
        if (comments != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.CrossGenomeMatch.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.CrossGenomeMatch)");
        }
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) &&"rtargetLocatedSequenceFeatureLocation".equals(notXml[i])) {
                i++;
                targetLocatedSequenceFeatureLocation = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Location.class);
                i++;
            };
            if ((i < notXml.length) &&"rtargetLocatedSequenceFeature".equals(notXml[i])) {
                i++;
                targetLocatedSequenceFeature = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.LocatedSequenceFeature.class);
                i++;
            };
            if ((i < notXml.length) &&"rtargetOrganism".equals(notXml[i])) {
                i++;
                targetOrganism = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Organism.class);
                i++;
            };
    ...
    public Class getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.CrossGenomeMatch.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.CrossGenomeMatch.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
