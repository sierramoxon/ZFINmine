...
public class GOAnnotationShadow implements GOAnnotation, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = GOAnnotation.class;
    ...
    // Col: org.intermine.model.bio.GOAnnotation.goEvidenceCodes
    protected java.util.Set<org.intermine.model.bio.GOEvidenceCode> goEvidenceCodes = new java.util.HashSet();
    public java.util.Set<org.intermine.model.bio.GOEvidenceCode> getGoEvidenceCodes() { return goEvidenceCodes; }
    public void setGoEvidenceCodes(final java.util.Set<org.intermine.model.bio.GOEvidenceCode> goEvidenceCodes) { this.goEvidenceCodes = goEvidenceCodes; }
    public void addGoEvidenceCodes(final org.intermine.model.bio.GOEvidenceCode arg) { goEvidenceCodes.add(arg); }

    // Col: org.intermine.model.bio.GOAnnotation.with
    protected java.util.Set<org.intermine.model.bio.BioEntity> with = new java.util.HashSet();
    ...
    public boolean equals(Object o) { return (o instanceof GOAnnotation && id != null) ? id.equals(((GOAnnotation)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "GOAnnotation [id=\"" + id + "\", ontologyTerm=" + (ontologyTerm == null ? "null" : (ontologyTerm.getId() == null ? "no id" : ontologyTerm.getId().toString())) + ", qualifier=\"" + qualifier + "\", subject=" + (subject == null ? "null" : (subject.getId() == null ? "no id" : subject.getId().toString())) + ", withText=\"" + withText + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("withText".equals(fieldName)) {
            return withText;
        }
        if ("goEvidenceCodes".equals(fieldName)) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("goEvidenceCodes".equals(fieldName)) {
            goEvidenceCodes = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        goEvidenceCodes = new ProxyCollection(os, this, "goEvidenceCodes", org.intermine.model.bio.GOEvidenceCode.class);
        with = new ProxyCollection(os, this, "with", org.intermine.model.bio.BioEntity.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("goEvidenceCodes".equals(fieldName)) {
            goEvidenceCodes.add((org.intermine.model.bio.GOEvidenceCode) element);
        } else if ("with".equals(fieldName)) {
