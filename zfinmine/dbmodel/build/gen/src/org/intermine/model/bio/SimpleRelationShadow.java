...
public class SimpleRelationShadow implements SimpleRelation, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = SimpleRelation.class;
    ...
    public boolean equals(Object o) { return (o instanceof SimpleRelation && id != null) ? id.equals(((SimpleRelation)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "SimpleRelation [id=\"" + id + "\", object=" + (object == null ? "null" : (object.getId() == null ? "no id" : object.getId().toString())) + ", subject=" + (subject == null ? "null" : (subject.getId() == null ? "no id" : subject.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.SimpleRelation.class.equals(getClass())) {
    ...
    public Class getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.SimpleRelation.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.SimpleRelation.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        ...
        sb.append("$_^org.intermine.model.bio.SimpleRelation");
        if (subject != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.SimpleRelation.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.SimpleRelation)");
        }
    ...
    public Class getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.SimpleRelation.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.SimpleRelation.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
