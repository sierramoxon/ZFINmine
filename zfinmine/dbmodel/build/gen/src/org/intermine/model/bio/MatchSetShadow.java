...
public class MatchSetShadow implements MatchSet, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = MatchSet.class;
    // Col: org.intermine.model.bio.MatchSet.matchParts
    protected java.util.Set<org.intermine.model.bio.MatchPart> matchParts = new java.util.HashSet();
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.MatchSet.class.equals(getClass())) {
    ...
    public Class getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.MatchSet.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.MatchSet.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        ...
        sb.append("$_^org.intermine.model.bio.MatchSet");
        if (comments != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.MatchSet.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.MatchSet)");
        }
        ...
        matchParts = new ProxyCollection(os, this, "matchParts", org.intermine.model.bio.MatchPart.class);
    ...
    public Class getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.MatchSet.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.MatchSet.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
