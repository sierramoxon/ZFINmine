...
public class GeneFlankingRegionShadow implements GeneFlankingRegion, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = GeneFlankingRegion.class;
    ...
    public boolean equals(Object o) { return (o instanceof GeneFlankingRegion && id != null) ? id.equals(((GeneFlankingRegion)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "GeneFlankingRegion [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", curated=\"" + curated + "\", direction=\"" + direction + "\", distance=\"" + distance + "\", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", id=\"" + id + "\", length=\"" + length + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + "]"; }
