...
public class DataSourceShadow implements DataSource, org.intermine.model.ShadowClass
{
    public static final Class shadowOf = DataSource.class;
    ...
    public boolean equals(Object o) { return (o instanceof DataSource && id != null) ? id.equals(((DataSource)o).getId()) : this == o; }
    public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    public String toString() { return "DataSource [description=\"" + description + "\", id=\"" + id + "\", name=\"" + name + "\", url=\"" + url + "\"]"; }
